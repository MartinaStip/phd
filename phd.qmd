...
Celkově jsou studující spokojeni s průběhem studia, zejména s podporou svých školících osob i institucionální podporou, způsobem výuky. Velmi kladně hodnotí také zázemí pro práci a atmosféru na pracovišti (@fig-study). Pokud tyto aspekty studia fungují, jsou výslovně oceňované i v otevřených komentářích. A naopak: špatná práce školících osob či vyučujících, nebo nedostatek týmového ducha na pracovišti jsou uváděné jako zásadní problémy (viz [Práce školících osob a vyučujících]).

Hůře hodnocené je množství povinností (@fig-study). V otevřených komentářích se jako problematická někdy jeví srozumitelnost a stabilita požadavků [Organizace studia], nerovnoměrná pracovní zátěž studujících [Organizace studia], nadbytečná byrokracie [Administrativa] nebo [Nedostatečná podpora akademických kompetencí].
...
Ještě pozitivnější zkušenost měli dotázaní s kvalitou vztahů na pracovišti (spolupráce s kolegy, přístup školitele k úspěchům doktorandů, vztah ke studujícím), a to jak pohledem kvantitativním (výrok “cítím se na pracovišti vítaný“), tak podle formulací otevřených komentářů. 
...
Studium je zejména na začátku poznamenané špatnou orientací v nové akademické roli. Týká se to jak výzkumné (jak publikovat) tak pedagogické (jak učit) práce. Mnozí studující kritizují, že se musí spoléhat hlavně sami na sebe, nepociťují v těchto ohledech dost podpory. 
...
Slabinou je v některých případech adekvátní komunikace publikačních požadavků a jejich náročnost. 
